...
privileged aspect PersonIntegrationTest_Roo_IntegrationTest {
    ...
    public void PersonIntegrationTest.testCountPeople() {
        ...
        long count = com.sixvu.domain.Person.countPeople();
    ...
    public void PersonIntegrationTest.testFindPerson() {
        com.sixvu.domain.Person obj = dod.getRandomPerson();
        ...
        obj = com.sixvu.domain.Person.findPerson(id);
    ...
    public void PersonIntegrationTest.testFindAllPeople() {
        ...
        java.util.List<com.sixvu.domain.Person> result = com.sixvu.domain.Person.findAllPeople();
    ...
    public void PersonIntegrationTest.testFindPersonEntries() {
        ...
        java.util.List<com.sixvu.domain.Person> result = com.sixvu.domain.Person.findPersonEntries(0, (int) count);
    ...
    public void PersonIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Person' failed to initialize correctly", dod.getRandomPerson());
        com.sixvu.domain.Person obj = dod.getNewTransientPerson(Integer.MAX_VALUE);
    ...
    public void PersonIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Person' with identifier '" + id + "'", com.sixvu.domain.Person.findPerson(id));
    }
